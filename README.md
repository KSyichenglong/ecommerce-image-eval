...
基于 13 年电商实战经验，提供结构化、数据驱动的主图评分框架。支持家具、家居/宠物类目，持续扩展中。
...
发送搜索页截图或至少 4-6 张竞品主图，让 AI 了解当前页面的竞争环境（什么颜色、什么结构是主流）。
...
```
【主图诊断信息】
市场主流颜色分布：__________（如"木质款为木色，塑料款为白色"）
市场主流构图方式：__________（如"中心点构图"）
市场主流核心卖点：__________（如"大空间和外观，塑料款除了最后一名外都是带猫砂盆一体"）
竞品最高销量款特征：__________（如"前后透明"）
...
| 类目 | 文件 | 状态 |
|------|------|------|
| 家居 | `references/鞋柜主图评分标准_v1.5.md` | ✅ 实战验证 |
| 宠物 | `references/猫别墅主图评分标准_v1.0.md` | 🔄 迁移版，待实战验证 |
